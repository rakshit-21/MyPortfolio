      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400">
                <a href="tel:8595324975" className="hover:text-white transition-colors duration-200">
                  8595324975
                </a>
              </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© {currentYear} Rakshit Suneja. All rights reserved.</p>
            <p className="text-gray-400 text-sm mt-4 md:mt-0">Built with React & Tailwind CSS</p>
          </div>
        </div>
      </div>
    </footer>
